...
#             current_idx = torch.argmax(scores, dim=-1).tolist()[0]
#             k = 0
#             for j in current_idx:
#                 current_char_=self.target_vocab.id2char[j]
#                 if current_char_ not in  ['}']:
#                     k+=1
#                     if current_char_ not in ['{', '}', '<pad>', '<unk>']:
#                         decodedWords[k-1] += current_char_
#                 else:
#                     break
#         return decodedWords
